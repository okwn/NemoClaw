...
description_agent: "Explains what workspace personality and configuration files are, where they live, and how they persist across sandbox restarts. Use when users ask about `SOUL.md`, `USER.md`, `IDENTITY.md`, `AGENTS.md`, or other workspace files, or when preparing to back up or restore workspace state."
...
See [Backup and Restore](/manage-sandboxes/backup-restore) for instructions.
</Warning>
...
- [Backup and Restore workspace files](/manage-sandboxes/backup-restore)
