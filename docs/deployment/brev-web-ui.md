...
description:
  ...
  agent: "Guides users through deploying NemoClaw with the Brev web UI. Use when a user wants to try NemoClaw without installing the CLI, or asks how to get started on Brev."
...
- [Set Up Messaging Channels](../manage-sandboxes/messaging-channels.md) to learn how to connect Telegram, Slack, or Discord.
- [Switch Inference Providers](../inference/switch-inference-providers.md) to learn how to change the model provider after setup.
- [Monitor Sandbox Activity](../monitoring/monitor-sandbox-activity.md) to learn how to inspect sandbox health and logs.
- [Deploy to a Remote GPU Instance](deploy-to-remote-gpu.md) to learn how to deploy NemoClaw to a remote GPU instance using the CLI.
- [Troubleshooting](../reference/troubleshooting.md) to learn how to fix common setup and runtime issues.
