...
title: "CLI Selection Guide"
sidebar-title: "CLI Selection Guide"
description: "Choose between the NemoClaw CLI and the OpenShell CLI for common sandbox operations."
description_agent: "Explains when to use `nemoclaw` versus `openshell` for NemoClaw-managed sandboxes, including lifecycle, inference, policy, monitoring, file transfer, and gateway operations."
...
- [Commands](/reference/commands) for the full NemoClaw command reference.
