...
description_agent: "Installs NemoClaw, launches a sandbox, and runs the first agent prompt. Use when onboarding, installing, or launching a NemoClaw sandbox for the first time."
...
<Accordion title="Option 1: NVIDIA Endpoints">
...
<Accordion title="Option 2: OpenAI">
...
<Accordion title="Option 4: Anthropic">
...
<Accordion title="Option 6: Google Gemini">
...
<Accordion title="Option 8: Model Router">
