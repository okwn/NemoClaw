...
description_agent: "Lists the hardware, software, and container runtime requirements for running NemoClaw. Use when verifying prerequisites before installation."
