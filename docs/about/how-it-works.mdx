...
NemoClaw architecture follows these principles.

| Principle | Meaning |
| --- | --- |
| Thin plugin, versioned blueprint | The sandbox plugin stays small and stable. Host-side orchestration uses a versioned blueprint and runner that can evolve on its own release cadence. |
...
- Read [Overview](/about/overview) for the product definition and common use cases.
